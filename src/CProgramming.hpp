...
/**
      \section CProgramming class
      This class represents programming file in a filesystem.
*/
class CProgramming :         public CFile{
  public:
    /**
        Class constructor.
        ...
        @returns None
    */
    CProgramming(const string & name,
    ...
    /**
        ...
        @returns None.
    */
    CProgramming                ( const CProgramming & pattern );
    /**
