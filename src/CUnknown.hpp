...
/**
      \section CUnknown class
      This class represents unknown type of file in a filesystem.
*/
class CUnknown :                public CFile{
  public:
    /**
        Class constructor.
    ...
    */
    ...
    /**
        ...
        @returns None.
    */
    CUnknown                    ( const CUnknown & pattern );
    /**
