...
/**
      \section CDiskMedia class
      This class represents disk-media file in a filesystem.
*/
class CDiskMedia :             public CFile{
  public:
    /**
        Class constructor.
    ...
    */
    ...
    /**
        ...
        @returns None.
    */
    CDiskMedia                ( const CDiskMedia & pattern );
    /**
